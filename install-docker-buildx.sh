...
UNAMEM=$(uname -m)
    case "$UNAMEM" in \
        armhf) ARCH='arm' ;; \
       armv6*) HURL=${HURLbase}/${HURLver}/buildx-${HURLver}.linux-arm-v6 ; HASHSUM=ef7790935ab148c6bae7182c228834ab21f6a758e7adf35768351f970d1cbe65 ;; \
       armv7*) HURL=${HURLbase}/${HURLver}/buildx-${HURLver}.linux-arm-v7 ; HASHSUM=8f0e32c9944c54aafb68887080fb8a973d9d6230e682a27a0b4edeede0dba757 ;; \
       aarch64) HURL=${HURLbase}/${HURLver}/buildx-${HURLver}.linux-arm64 ; HASHSUM=5be8043acfc2dce0550bc249c348d853e8f4548c45c264102e5250ebcaf3d291 ;; \
        x86_64) HURL=${HURLbase}/${HURLver}/buildx-${HURLver}.linux-amd64 ; HASHSUM=c21f07356de93a4fa5d1b7998252ea5f518dbe94ae781e0edeec7d7e29fdf899 ;; \
        x86_64) HURL=${HURLbase}/${HURLver}/buildx-${HURLver}.linux-ppc64le ; HASHSUM=92a23faca38d1f571584c8603c4f59bfeb09e21ef5f3dffa0bba36d272c07e65 ;; \
        x86_64) HURL=${HURLbase}/${HURLver}/buildx-${HURLver}.linux-s390x ; HASHSUM=82631e68e21bcb544d3dd407da34c0a2cd59df860ba3c7505a2d6b2629bb95a9 ;; \
        *) echo >&2 "error: unsupported architecture: $UNAMEM"; exit 1 ;; \
    esac &&
